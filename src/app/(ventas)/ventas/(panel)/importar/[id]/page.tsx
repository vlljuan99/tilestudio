...
export const metadata = { title: 'Estado de la importación' }

export default async function EstadoImportacionPage({
  params,
}: {
  ...
  const initial: Progress = {
    ...
    seriesCount: new Set(items.map((c) => (c.seriesName || '').toLowerCase()).filter(Boolean))
      .size,
