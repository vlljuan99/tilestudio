...
export const metadata = { title: 'Importaciones de catálogos', robots: { index: false } }
    ...
    <div className="container py-6 max-w-4xl">
      <header className="mb-6 flex flex-wrap items-center gap-3">
        <div className="flex-1">
          <h1 className="text-2xl md:text-3xl">Importaciones de catálogos</h1>
          <p className="text-sm text-muted-foreground">
            Cada catálogo PDF que subes se procesa aquí; luego revisas los azulejos encontrados y
            los publicas en tu web.
          </p>
        </div>
        <Link
